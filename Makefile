...
LDFLAGS := -X github.com/openshift-eng/cyborg-data.Version=$(VERSION) \
           -X github.com/openshift-eng/cyborg-data.GitCommit=$(GIT_COMMIT) \
           -X github.com/openshift-eng/cyborg-data.GitTreeState=$(GIT_TREE_STATE) \
           -X github.com/openshift-eng/cyborg-data.BuildDate=$(BUILD_DATE)
